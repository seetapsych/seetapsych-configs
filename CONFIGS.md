...
| HeadDetection (CoSI) | 0.0.1 | Head detection module for CoSI gaze following estimation with YOLO-based detector and head selection | [Download](https://raw.githubusercontent.com/seetapsych/seetapsych-gaze-following/main/seetapsych_gaze_following/modules/head_detection.yml) | [Homepage](https://github.com/seetapsych/seetapsych-gaze-following) |
| Gaze Following (CoSI) | 0.0.1 | CoSI model for gaze following estimation, provides gaze point and social gaze relation | [Download](https://raw.githubusercontent.com/seetapsych/seetapsych-gaze-following/main/seetapsych_gaze_following/modules/cosi.yml) | [Homepage](https://github.com/seetapsych/seetapsych-gaze-following) |
